    ...
    <section className="col-span-12">
      <div className="grid grid-cols-12 gap-3 md:gap-4">
        <div className="col-span-12 lg:col-span-4 rounded-2xl border bg-white/70 dark:bg-neutral-900/70 p-4">
          ...
          <div className="mt-4">
            <button onClick={() => { localStorage.clear(); location.reload(); }} className="text-sm px-3 py-2 rounded-xl border bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800">
              Reset demo data
            </button>
          </div>
        </div>
