            ...
            <tbody>
              {pageSales.map((s)=> (
                <tr key={s.id} className="border-t dark:border-neutral-800">
                  ...
                  <td className="py-2 px-2"><button onClick={()=>printReceipt(s)} className="text-sm px-2 py-1 rounded-lg border bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800">Print</button></td>
                </tr>
              ))}
