...
export default function ProductCard({ product, rem, low, oos, onAdd }) {
  return (
    <button
      ...
      disabled={oos}
      className={`group relative rounded-2xl overflow-hidden border transition-all ${oos? 'bg-neutral-100 dark:bg-neutral-800 border-neutral-200 dark:border-neutral-700 opacity-70 cursor-not-allowed' : 'bg-white dark:bg-neutral-900 hover:shadow-lg border-neutral-200 dark:border-neutral-700 hover:border-brand-200'}`}
    >
